...
class BattleCollectionEntityBuilderTest {
    ...
    void 솔로랭크_녹아웃을_업데이트한다() {
        ...
        // when
        BattleCollectionEntity battleEntity = new BattleCollectionEntityBuilder(playerEntity, battleResponse).build();

        // then
        assertBattle(battleEntity, battleResponse, playerEntity);
        assertBattleTeams(battleEntity.getTeams(), battleResponse.battle().teams());
    }
    ...
    void 솔로_쇼다운을_업데이트한다() {
        ...
        // then
        assertBattle(battleEntity, battleResponse, playerEntity);
        assertBattlePlayers(battleEntity.getTeams(), battleResponse.battle().players());
    }
