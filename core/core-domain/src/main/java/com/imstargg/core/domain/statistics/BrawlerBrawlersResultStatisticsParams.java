...
public record BrawlerBrawlersResultStatisticsParams(
    ...
    public List<BrawlerBrawlersResultStatisticsParam> toParamList() {
        return new StatisticsParamBuilder()
                ...
                .build((battleDate, trophyRange, soloRankTierRange, duplicateBrawler) ->
                        new BrawlerBrawlersResultStatisticsParam(
                                brawlerId,
                                battleDate,
                                trophyRange,
                                soloRankTierRange
