...
public class BattleUpdateJobConfig {
    ...
    @StepScope
    QuerydslPagingItemReader<PlayerLastBattleProjection> reader() {
        return new QuerydslPagingItemReader<>(emf, chunkSizeJobParameter().getSize(), queryFactory -> queryFactory
                .select(
