...
@Configuration
@EnableConfigurationProperties(BattleUpdateJobConfig.Properties.class)
class BattleUpdateJobConfig {
    ...
    public BattleUpdateJobConfig(
            BattleUpdateJobConfig.Properties properties,
            Clock clock,
    ...
    Step step() {
        ...
        if (properties.asyncEnabled()) {
            return configureFaultTolerantAndBuild(stepBuilder
                    .<PlayerCollectionEntity, Future<PlayerBattleUpdateResult>>chunk(properties.chunkSize(), txManager)
                    .reader(reader())
    ...
    private <T> Step configureFaultTolerantAndBuild(
            SimpleStepBuilder<PlayerCollectionEntity, T> stepBuilder) {
        return stepBuilder
    ...
    @ConfigurationProperties(prefix = "app.batch.battle-update-job")
    record Properties(
            int chunkSize,
