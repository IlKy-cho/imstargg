...
import com.imstargg.batch.domain.statistics.BrawlersBattleRankStatisticsCollector;
...
public class BrawlersBattleRankStatisticsJobItemProcessor
        implements ItemProcessor<Long, List<BrawlersBattleRankStatisticsCollectionEntity>> {

    private static final Logger log = LoggerFactory.getLogger(BrawlersBattleRankStatisticsJobItemProcessor.class);
    ...
    public BrawlersBattleRankStatisticsJobItemProcessor(
    ...
    @Override
    public List<BrawlersBattleRankStatisticsCollectionEntity> process(Long item) throws Exception {
        ...
        long eventId = item;
        var collector = new BrawlersBattleRankStatisticsCollector(emf, date, item);
