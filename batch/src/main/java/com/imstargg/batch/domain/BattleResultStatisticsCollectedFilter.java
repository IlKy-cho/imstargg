...
import static com.imstargg.storage.db.core.statistics.QStatisticsCollectedBattleResultCollectionEntity.statisticsCollectedBattleResultCollectionEntity;
...
public class BattleResultStatisticsCollectedFilter {
    ...
    private Set<String> getExistingBattleKeys(Map<String, BattleCollectionEntity> battleKeyToBattle) {
        return new HashSet<>(
                getQueryFactory()
                        .select(statisticsCollectedBattleResultCollectionEntity.battleKey)
                        .from(statisticsCollectedBattleResultCollectionEntity)
                        .where(statisticsCollectedBattleResultCollectionEntity.battleKey.in(battleKeyToBattle.keySet()))
                        .fetch()
        );
    }
