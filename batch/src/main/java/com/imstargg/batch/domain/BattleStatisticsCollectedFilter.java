...
@Component
public class BattleStatisticsCollectedFilter {

    private final EntityManagerFactory emf;

    public BattleStatisticsCollectedFilter(EntityManagerFactory emf) {
        this.emf = emf;
    }

    public List<BattleCollectionEntity> filter(Collection<BattleCollectionEntity> battles) {
