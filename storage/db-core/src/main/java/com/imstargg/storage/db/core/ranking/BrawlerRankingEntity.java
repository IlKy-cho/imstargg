...
@Entity
@Table(
        name = "brawler_ranking",
        uniqueConstraints = {
                @UniqueConstraint(
                        name = "uk_brawler_ranking__country_brawler_rank",
                        columnNames = {"country", "brawler_brawlstars_id", "rank_value"}
                )
        }
)
public class BrawlerRankingEntity extends BaseEntity {
    ...
    protected BrawlerRankingEntity() {
    }
